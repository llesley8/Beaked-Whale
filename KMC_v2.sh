#!/bin/bash
#SBATCH --job-name=bwKMC2 # Name the job bwKMC2 to the queue
...
#SBATCH --output=KMC_v2.out # output file
#SBATCH --error=KMC_v2.err # error file
...
kmc -k21 -t12 -ci1 /hb/groups/kelley_training/beaked_whale/PBmixRevio1579_2_A01_PHGP_30hours_1-121kbExpressCCSv32hrPE_250pM_Mesoplodon_bc2072_CCSExpress/m84053_240607_205216_s1.hifi_reads.bc2072.fastq.gz 21mers_v2 .
